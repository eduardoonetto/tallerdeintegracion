          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Total Ventas Historico</p>
                <h4 class="mb-0">$<?= $count_sum_total_amount['total_amount'] ?></h4>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?= $count_user['total_users'] ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">OTs Pendientes</p>
                <h4 class="mb-0"><?= $count_work_orders_pending['total'] ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Aseguradoreas Vigentes</p>
                <h4 class="mb-0"><?= $count_insurances_vigentes['total'] ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
      ...
      <div class="row mt-4">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              <h6 class="mb-0 "> Trabajadores por día </h6>
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2  ">
            ...
            <div class="card-body">
              <h6 class="mb-0 "> Casos Cerrados </h6>
        ...
        <div class="col-lg-4 mt-4 mb-3">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              <h6 class="mb-0 ">Olgura de las OTs</h6>
              <p class="text-sm ">Last Campaign Performance</p>
              <hr class="dark horizontal">
              <div class="d-flex ">
                <i class="material-icons text-sm my-auto me-1">schedule</i>
