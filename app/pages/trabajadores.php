          ...
          <div class="card h-100">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h5 class="text-white text-capitalize ps-3">Ingreso de trabajadores</h5>
              </div>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="input-group input-group-static mb-4">
                      <label for="exampleFormControlSelect1" class="ms-0">Cargo</label>
                      <select class="form-control" id="cargo" name="cargo" required>
                        <option value="1">Desabollador</option>
                        <option value="2">Pintor</option>
                        <option value="3">Preparador</option>
                        <option value="4">Pulidor</option>
          ...
          <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <h6 class="text-white text-capitalize ps-3">Trabajadores Ingresados</h6> 
              </div>
            </div>
