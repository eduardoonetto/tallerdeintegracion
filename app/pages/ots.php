...
$count_work_orders_done = $Dashboard->count_work_orders_by_status('Completa');
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1"><?= $count_work_orders_pending['total'] ?> Pendientes</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php 
                    $workOrderData = $Dashboard->list_work_orders_by_status('Pendiente');
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                      <a href="./ordentrabajo.php?ot=<?= $workOrder['workorder_id'] ?><?php echo ($workOrder['total_amount'] == 0 ? '' : '&edit=true')?> "><span class="badge badge-sm bg-gradient-warning">Editar</span></a>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <a href="../processor/transactioner.php?tx=completarOt&id_ot=<?= $workOrder['workorder_id'] ?>" <?php echo ($workOrder['total_amount'] == 0 ? 'disabled' : '')?> onclick="return !this.hasAttribute('disabled');"><span class="badge badge-sm <?php echo ($workOrder['total_amount'] == 0 ? 'bg-gradient-secondary' : 'bg-gradient-success')?>" <?php echo ($workOrder['total_amount'] == 0 ? 'data-bs-toggle="tooltip" data-bs-placement="top" title="OT no puede estar en $0" data-container="body" data-animation="true"' : '')?>  >
Marcar como Terminada</span></a>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <a href="../processor/transactioner.php?tx=AnularOt&id_ot=<?= $workOrder['workorder_id'] ?>"><span class="badge badge-sm bg-gradient-danger">Anular OT</span></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
